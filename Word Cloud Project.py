...
def my_upload():
    ...
    my_upload_widget = fileupload.FileUploadWidget()
    ...
    my_upload_widget.observe(my_cb, names='data')
    ...
    for word in split_text:
        for letter in word:
            for symbol in punctuations:
                if letter in punctuations and symbol == letter:
                    new_word = letter.replace(symbol, "")
                    lst.append(new_word)
                else:
                    lst.append(word)
